...
.then(dataEvents =>{
    ...
    const upComingEvents = filterUpComingEvents(dataEvents.events, currentDate)
    const allCategories = obtainCategories(upComingEvents)
...
function filterUpComingEvents(event, currentDate){
